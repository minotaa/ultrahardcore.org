  ...
  {#if !success}
    ...
    <form on:submit={handleSubmit}>
      <div class="flex flex-col gap-2 justify-center">
        ...
        <select bind:value={serverRegion} required name="serverRegion" id="serverRegion" class="dark:text-white shadow dark:bg-slate-700 rounded-lg bg-slate-100 pt-2 pb-2 w-96 pl-2">
        ...
        <input required bind:value={serverLocation} placeholder="for example: Montreal, Canada" class="dark:bg-slate-700 shadow bg-slate-100 gap-2 rounded-lg pt-2 pb-2 pl-2 pr-8 w-96" type="text" name="serverLocation" id="serverLocation"/>
